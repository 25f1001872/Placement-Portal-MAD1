...
def student_dashboard():
    ...
    return render_template('student_dashboard.html' , companies = companies, applied_drives = applied_drives, student_name = student_name)
...
def company_profile(company_id):
    ...
    return render_template('company_profile.html', profile = profile, drive_info = drive_info)
...
def applications_history():
    ...
    return render_template('applications_history.html', applications = applications, Remark = "None")
...
def drive_details(drive_id):
    ...
    return render_template('drive_details.html', drive = drive_info)
